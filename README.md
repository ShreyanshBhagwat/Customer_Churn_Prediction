...
o	Demographics (gender, senior citizen, partner, dependents)
o	Account information (tenure, contract type, payment method)
o	Services subscribed (internet, phone, streaming services)
...
Customer churn prediction is a critical business problem in industries like telecom, banking, and SaaS.
This project demonstrates the ability to:
•	Translate a business problem into a ML solution
